/*
    ...
    - JS 데이터 종류
        ...
        4) 배열   : [ 데이터 1, 데이터 2, 데이터 3 ~ ] 
         ...
         5. 배열 수정
            1) 전체 수정 : 변수명 = [새로운 배열]
            2) 특정 인덱스내 데이터수정 : 변수명[인덱스번호] = 새로운 데이터

         6. 배열내 데이터 추가
            변수명.push (데이터)

         7. 배열내 특정 데이터 삭제
            1) 변수명.splice (인덱스 , 1) : 삭제할 인덱스 1개 삭제한다.(한칸씩 당겨진다)
            2) 변수명.splice (인덱스 , 0 , '새로운데이터') : 특정 인덱스에 새로운 데이터 삽입(한칸씩 밀린다)
    ...
    console.log(과일상자변수[1]) // 변수명(인덱스) ===> 바나나
    console.log(과일상자변수[2]) // 변수명(인덱스) ===> 포도
    console.log(과일상자변수[3]) // 변수명(인덱스) ===> undefined , 없는 위치/인덱스 이기 때문에
    ...
    console.log(과일상자변수.indexOf('포도')); // 3번째 존재 ===> 인덱스 : 2
        ...
        //활용
    let 삭제할인덱스 = 과일상자변수.indexOf('포도'); // 2 ==> 반환된 2를 삭제할 인덱스 변수에 저장
    과일상자변수.splice(삭제할인덱스,1)             // 과일상자변수.splice(2,1) =>[ '바나나' , `수박` , `체리`]
    console.log(과일상자변수);
