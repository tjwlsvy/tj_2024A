...
- JS 데이터/자료
    1. 문자 2. 숫자 3. 논리 4. undefined 5. [] 6. function
        : 여러개의 데이터/자료를 저장할수 있는 하나의 데이터 자료
    - function 함수
...
- 실습을 통해 활용
    실습예) 게시판을 만다는데 제목 , 내용 ,비밀번호 필요하다
        만일 2개의 게시물이 존재할경우 변수의 설계 정의
        '제목 1' '내용1' '1234'
        '제목 1' '내용1' '1234'
            1. 변수만 사용할경우
            ...
            - 단점 : 게시물의 정보/필드 출력시 split(분류) 분리해야 되므로 분류 순서가 일치하고 관리가 힘들다.
            
            - 모든 단점을 해결하고자 나온 문법 : 객체지향 프로그래밍
